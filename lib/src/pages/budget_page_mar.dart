...
class BudgetPageMar extends StatefulWidget {
  const BudgetPageMar({Key? key, required this.items}) : super(key: key);

  static const routeName = '/mar';
  ...
  @override
  State<BudgetPageMar> createState() => _BudgetPageMarState();
}

class _BudgetPageMarState extends State<BudgetPageMar> {
  final List<Tab> myTabs = <Tab>[
    const Tab(text: 'Budget'),
    const Tab(text: 'Monthly Summary'),
  ];

  String dropdownValue = BudgetPageMar.months[2];
