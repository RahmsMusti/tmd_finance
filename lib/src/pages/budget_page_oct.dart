...
class BudgetPageOct extends StatefulWidget {
  const BudgetPageOct({Key? key, required this.items}) : super(key: key);

  static const routeName = '/oct';
  ...
  @override
  State<BudgetPageOct> createState() => _BudgetPageOctState();
}

class _BudgetPageOctState extends State<BudgetPageOct> {
  final List<Tab> myTabs = <Tab>[
    const Tab(text: 'Budget'),
    const Tab(text: 'Monthly Summary'),
  ];

  String dropdownValue = BudgetPageOct.months[9];
              ...
              Row(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: BudgetPageOct.months.map((name) {
