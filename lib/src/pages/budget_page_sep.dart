...
class BudgetPageSep extends StatefulWidget {
  const BudgetPageSep({Key? key, required this.items}) : super(key: key);

  static const routeName = '/sep';
  ...
  @override
  State<BudgetPageSep> createState() => _BudgetPageSepState();
}

class _BudgetPageSepState extends State<BudgetPageSep> {
  final List<Tab> myTabs = <Tab>[
    const Tab(text: 'Budget'),
    const Tab(text: 'Monthly Summary'),
  ];

  String dropdownValue = BudgetPageSep.months[8];
              ...
              Row(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: BudgetPageSep.months.map((name) {
